...
async function displayProductsByClass(products) {
    const MAIN_CLASS = 'Espresso Machine';
    ...
    const preferredOrder = ['Advance Espresso Machine','High End','Full Accessory','Half Full Accessory','Mid Range','UnAdvance Coffee Maker','Low End'];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    fetchclickforProduct();
    console.log("oi done loading");
});
fetchProducts();
